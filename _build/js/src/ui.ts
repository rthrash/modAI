...
const applyStyles = (element: HTMLElement, styleObj: Partial<CSSStyleDeclaration>) => {
    Object.assign(element.style, styleObj);
}

const createElement = <K extends keyof HTMLElementTagNameMap>(type: K, styleObj?: Partial<CSSStyleDeclaration>, textContent: string = ''): HTMLElementTagNameMap[K] => {
...
const createContentIframe = (providedContent: string, modal: Modal, customCSS: string[] = []) => {
...
const createModal = (config: Config) => {
    if (!config.key) {
